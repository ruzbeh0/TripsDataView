declare module "cs2/bindings" {
  ...
  export interface ManualUITagsConfiguration {
  	...
  	toolOptionsTransit: string;
  	toolOptionsVegatationAge: string;
  	toolOptionsTransitComplexCurve: string;
  	toolOptionsTransitContinuous: string;
  	toolOptionsTransitGrid: string;
  	toolOptionsTransitReplace: string;
  	toolOptionsTransitSimpleCurve: string;
  	toolOptionsTransitStraight: string;
  ...
  const parallelTransitupported$: ValueBinding<boolean>;
  const parallelMode$: ValueBinding<boolean>;
  const parallelOffset$: ValueBinding<number>;
  const undergroundTransitupported$: ValueBinding<boolean>;
